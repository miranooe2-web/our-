 ...
 * Tapping expands into a sheet with the full love letter.
 */
  ...
  return (
    <div className="animate-fade-up">
      <div className="mb-3 flex items-baseline justify-between px-1">
        ...
        <span className="text-[11px] font-medium text-rose-400">tap to read the letter</span>
      </div>
          ...
          <div className="-mx-2 -mt-2">
            {src(active.image) ? (
              ...
              (() => {
                ...
                return (
                  <div className={`relative grid aspect-[16/10] w-full place-items-center overflow-hidden rounded-2xl bg-gradient-to-br ${motif.gradient}`}>
                    <motif.icon className="h-12 w-12 text-white/85 drop-shadow-sm" />
